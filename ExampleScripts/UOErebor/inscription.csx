...
public static class InscriptionMenu
{
    ...
    public static InscriptionScroll AnimateDead = new InscriptionScroll(Specs.NecroScrollOfAnimateDead, Specs.BlankScroll,
        new CraftResource[] { new CraftResource(Specs.Bone, 3) },
    ...
    public static InscriptionScroll FrostBolt = new InscriptionScroll(Specs.ScrollFrostBolt, Specs.BlankScroll, "Frost Bolt Scroll");
}
