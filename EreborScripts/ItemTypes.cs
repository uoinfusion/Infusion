...
public static class ItemTypes
{
    ...
    public static readonly ModelId BodyOfBird = (ModelId)0x2006;
    ...
    public static readonly ModelId BodyOfRabbit = (ModelId) 0x2006;

    public static readonly ModelId[] MassKillSubjects = {Bird, Rabbit};
    public static readonly ModelId[] RippableBodies = {BodyOfBird, BodyOfRabbit};
